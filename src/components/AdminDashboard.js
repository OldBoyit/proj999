...
function AdminDashboard() {
    ...
    const goToHomePage = () => {
        navigate('/');  // Assicurati che questo percorso sia definito nel tuo router come Home page
    };
    ...
    return (
        <div>
            ...
            <button onClick={goToHomePage} style={{ marginTop: '20px', backgroundColor: '#4CAF50', color: 'white' }}>Torna alla Home</button> {/* Bottone per tornare alla Home con stile distinto */}
