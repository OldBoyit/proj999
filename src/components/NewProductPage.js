	...
	return (
	  <div>
		...
		<div className="example-text">
		  <p>Questa pagina è specificamente progettata per l'aggiunta di un prodotto alla volta, differenziandosi da altre pagine dell'applicazione che possono gestire operazioni batch o multiple.</p>
